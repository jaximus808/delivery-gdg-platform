...
func New(url string, apiKey string) *Database {
	client := postgrest.NewClient("https://lmvouzyrfptsnfmaigwv.supabase.co",
		"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imxtdm91enlyZnB0c25mbWFpZ3d2Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2MDI0OTA0NywiZXhwIjoyMDc1ODI1MDQ3fQ.CffRKwX3nkrWCElhSQC4KKNrcmlbLfZAGQ6CHZU4udE", nil)
